        ...
        >
          <div>
            <Stack spacing={1} sx={{ mb: 3 }}>
              <Typography variant="h4">프리셋을 변경 해 주세요.</Typography>
              <Typography color="text.secondary" variant="body2">
                회사의 정책에 맞게 프리셋을 변경 해 주세요.
              </Typography>
              <Typography color="text.secondary" variant="body2">
                직급을 클릭해서 수정 해 주세요
              </Typography>
            ...
            <Stack spacing={3}>
              <Card>
                <CardContent>
                  <Typography>부장</Typography>
                </CardContent>
              </Card>
              <Card>
                <CardContent>
                  <Typography>과장</Typography>
                </CardContent>
              </Card>
              <Card>
                <CardContent>
                  <Typography>대리</Typography>
                </CardContent>
              </Card>
              <Card>
                <CardContent>
                  <Typography>사원</Typography>
                </CardContent>
              </Card>
              <Grid container>
                <Grid xs={5} lg={6}>
